#!/bin/bash
slcli -y vs create --datacenter=sjc03 --hostname=master --domain=benchmarks.ejw --billing=hourly --key=rcordell --cpu=2 --memory=4096 --disk=100 --network=1000 --os=CENTOS_LATEST_64
sleep 5
slcli -y vs create --datacenter=sjc03 --hostname=slave1 --domain=benchmarks.ejw --billing=hourly --key=rcordell --cpu=2 --memory=4096 --disk=100 --network=1000 --os=CENTOS_LATEST_64
sleep 5
slcli -y vs create --datacenter=sjc03 --hostname=slave2 --domain=benchmarks.ejw --billing=hourly --key=rcordell --cpu=2 --memory=4096 --disk=100 --network=1000 --os=CENTOS_LATEST_64
